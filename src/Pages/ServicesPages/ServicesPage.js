        ...
        <div className="servicesPage--serviceGrid">
          <div className="servicesPage--gridItem web">
            ...
            <p>
              ...
              designed to run on most web browsers and devices such as Desktops,
              Laptops, Mobiles and Tablets. We follow mobile first approach in
              designing the sitemap and creating multimedia content for web
              pages. We offer static as well as dynamic web sites ranging from
              information websites, subscription-based websites, news websites,
              business websites and social networking websites.
            </p>
          ...
          <div className="servicesPage--gridItem">
            ...
            <p>
              ...
              we can develop an application to turn your objective into reality.
              Our solutions find relevance in almost every industry and business
              type such as salon, restaurants, café, ecommerce, retail,
              wholesale, manufacturing, etc.
            </p>
            <CustomButton type="button">READ MORE..</CustomButton>
          </div>
